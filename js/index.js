...
* @Last Modified by:   宏达
* @Last Modified time: 2017-09-22 23:48:39
*/
window.onload=function(){
 ...
 //    let tt=setInterval(amove,2000);
    
 //    function amove(){
 //    	while(zhuti.style.left>=0){
 //    		animate(zhuti,{left:-bgw});
 //    		zhuti.style.left-=bgw;
 //    	}
    	
	// }
	// function bmove(){
 //        if(zhuti.style.left<=zhutiw){
 //    		animate(zhuti,{left:bgw});
 //    	}
	// }
